...
NDiplomacy = {
	...
	CELESTIAL_EMPIRE_MANDATE_PER_STATE_WITH_PROSPERITY = 0.12,	-- Yearly change of Mandate for each State with prosperity.
	...
	CELESTIAL_EMPIRE_MANDATE_PER_5_LOANS = -0.24,	-- Yearly change of Mandate for every 5 loans.
...
NReligion = {
	...
	YEARLY_HARMONIZATION_PROGRESS = 0.10, 			-- 3% (10%)
